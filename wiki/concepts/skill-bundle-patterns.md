...
**New in Iteration 8.** The [[xpshacl-explainable-shacl]] and [[shacl-data-quality-69-metrics]] examples demonstrate an emerging pattern: SHACL validation is paired with an explanation layer that converts technical validation results into natural language. The Violation KG caching mechanism (99.48% hit rate) shows that validation errors are highly repetitive — a signature-based cache makes explainable validation practical.
...
**New in Iteration 8.** [[graphguard-os-guardrails]] introduces a sophisticated guardrails pattern: SHACL shapes for structural constraints, Cypher policies for behavioral rules, and a Shadow Policy Manager for safe rule evolution. This addresses the "rules that almost work" problem by testing candidate policies against production traffic.
...
- **Formal SSSOM skill implementations** — SSSOM is a specification, not yet paired with agent skills (addressed in part by adding [[sssom-mapping-protocol]])
