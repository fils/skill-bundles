...
* [Bidirectional SHACL ↔ LLM Bridge](bidirectional-shacl-llm-bridge.md) - A **bidirectional SHACL ↔ LLM bridge** is a bundle that uses LLMs to translate between natural-language requirements and SHACL shapes in both directions:
* [Constraint Rules as Skill Context](constraint-rules-as-context.md) - Some skill bundles encode **prohibitions and constraint rules** directly into their SKILL.md files, going beyond procedural instructions to enforce behavioral boundaries.
* [OKF Knowledge Bundle — Format Rules for this Wiki](okf-knowledge-bundle.md) - Local summary of Open Knowledge Format (OKF) v0.1 rules used by the skill-bundles wiki for agents and humans.
