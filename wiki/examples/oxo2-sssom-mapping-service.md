...
composition_notes: |
  OxO2 demonstrates the formal context artifact pattern applied to a production bioinformatics service.
...
### SSSOM Compliance
OxO2 implements the [[sssom-mapping-protocol]] standard:
...
## Composition Pattern
This project is the **third SSSOM implementation** in our catalog (after [[sssom-mapping-protocol]] spec and [[onto-llm-mapping]] mapping generator), but the **first to combine SSSOM with agent context documentation** (CLAUDE.md). It represents a mature production system where the ontology mapping standard and the AI assistant context pattern coexist.

## Source Attribution
Raw source: [[../../raw/2026-05-25/oxo2-claude.md]]
