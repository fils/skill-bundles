...
composition_notes: |
  Large ecosystem catalog demonstrating taxonomy-based organization at 179 skills.
  Contains an implicit security bundle (4+ guardrail skills) and memory management bundle.
  Similar to [[claude-skills-ecosystem-1116]] but focused on CLI utilities rather than general skills.
...
agent-hardening + messageguard + error-guard + totp = **defensive skill bundle**. This is analogous to [[graphguard-os-guardrails]] (SHACL + Cypher + Shadow) but at the CLI utility level.
...
audit-code + clean-pytest + dependency-audit + tdd-helper + sql-query-generator = **development workflow bundle**, similar to the patterns in [[agentic-engineering-workflow-skills]].

## Source Attribution
Raw source: [[../../raw/2026-05-25/awesome-openclaw-skills-cli.md]]
