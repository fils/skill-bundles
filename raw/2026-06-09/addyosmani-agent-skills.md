# Addy Osmani Agent Skills (Production-Grade Engineering)

**Source:** https://github.com/addyosmani/agent-skills
**Date Retrieved:** 2026-06-09
**Type:** GitHub Repository - Production-Grade Engineering Skill Bundle (23 Skills)
...
## Project Structure (Context Element: Bundle Organization)
...
> "**Rationalizations:** A table of common excuses agents use (e.g., \"I'll add tests later\") and the required rebuttal."

> "**Verification:** Non-negotiable evidence requirements (tests, build logs, runtime data). \"Seems right\" is never accepted."

> "**Beyonce Rule:** \"If you liked it, you shoulda put a test on it.\""

> "**Doubt-Driven Development:** Adversarial review of in-flight decisions (CLAIM → EXTRACT → DOUBT → RECONCILE)."

> "**Google Engineering Culture:** Incorporates practices like **Hyrum's Law**, **Chesterton's Fence**, and **Trunk-based development**."

> "Every skill follows a strict format to ensure agents don't just \"read\" but \"execute\"."
...
- Explicit verification gates for every skill
- Reference checklists (Testing, Security, Performance, Accessibility)
- Persona definitions for consistent behavior
- Slash commands for deterministic phase transitions
